...
# CRIA CLASSES DA LIGUAGEM PYTHON QUE SIMBOLIZAM TABELA DO BCDD, E O DJANGO TRANSFORMA EM TABELAS DE BCDD
# python manage.py makemigrations = cria model(tabela?) das classes
# python manage.py migrate  == criar arquivos e tabelas no banco de dados
#  ||    ||       createsuperuser == criar admin
# class Usuario (models.Model):
#   nome = models.CharField(max_length=50)
#  idade = models.IntegerField() #só armazena númeeros inteiros
